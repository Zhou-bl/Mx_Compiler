import os
import time
# export CLASSPATH="/mnt/d/周秉霖/coding/Mx_Compiler/antlr-4.10.1-complete.jar:$CLASSPATH"

os.system("cd ../src && rm ./*.class && rm ./*/*.class && rm ./*/*/*.class && rm ./*/*/*/*.class && rm ./*/*/*/*/*.class && cd ../debug")

judge_list = open("../input_data/testData/codegen/judgelist.txt").readlines()
...
for judge in judge_list:
    ...
    code_file = judge.replace("\n", "").replace("./", "../input_data/testData/codegen/")
    # print(code_file)
